    ...
    <div className="min-h-screen bg-black text-white">
      ...
      {currentStep === 2 && (
        <div className="bg-[#2D2D2D] border border-white rounded-lg py-4 m-10">
          ...
          <div className="px-4 mt-4 flex flex-col gap-4">
            <input className="h-[40px] bg-[#1c1c1c] border border-white px-3 rounded-lg" placeholder="Title" />
...
{currentStep === 3 && (
  ...
  >
    ...
    <p className="text-xs text-white px-4 mt-4">
      1. Self-fund: You use your own money to create the task. This
      means you will be responsible for providing the reward money that
      will be given to the person who successfully completes the task.
    </p>

    <p className="text-xs text-white px-4 mt-4">
      2. Self-fund: You use your own money to create the task. This
      means you will be responsible for providing the reward money that
      will be given to the person who successfully completes the task.
    </p>
          ...
          <button id="infom" className="relative">
            ...
            <div className="relative">
              ...
              >
                ...
                <p className="text-xs text-black mt-2">
                  For % split: Reward is distributed according to custom percentages.
                </p>
      ...
      >
        <div className="bg-[#2D2D2D] border border-white rounded-lg w-[90%] max-w-[420px] p-6 flex flex-col gap-4 text-white">
          ...
          <div className="flex flex-col gap-2">
            <button className="preset-btn border border-white rounded-lg px-3 py-2 text-sm" data-value="[40,30,20,5,5]">
              [40, 30, 20, 5, 5]
            </button>

            <button className="preset-btn border border-white rounded-lg px-3 py-2 text-sm" data-value="[40,30,20,10]">
              [40, 30, 20, 10]
            </button>

            <button className="preset-btn border border-white rounded-lg px-3 py-2 text-sm" data-value="[50,30,20]">
              [50, 30, 20]
            </button>

            <button className="preset-btn border border-white rounded-lg px-3 py-2 text-sm" data-value="[50,50]">
              [50, 50]
            </button>
          </div>
      ...
      <div>
        ...
        <div className="flex flex-row gap-2 items-center text-white text-[11px] md:text-xs mt-2">
          ...
          <button className="border border-white rounded-lg bg-[#2D2D2D] px-2 py-1">
            Seek Funding <span className="text-[11px] text-red-900">soon</span>
          </button>
        </div>
      </div>
